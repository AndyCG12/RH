                ...
                <table id="data-table-buttons" width="100%" class="table table-striped table-bordered align-middle text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="align-items: center; text-align:center;">{{ $razonSocial->nombre }}</td>
                            <td style="align-items: center; text-align:center;">{{ $razonSocial->direccion }}</td>
                            <td style="align-items: center; text-align:center;">{{ $razonSocial->rfc}}</td>
                            <td nowrap>
            ...
            <div class="modal-body">
                <form action="{{ route('razones.update', $razonSocial->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-5">
                        ...
                        <input type="text" class="form-control" id="rfc" name="rfc" value="{{ $razonSocial->rfc }}" required maxlength="13">
                    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h4 class="modal-title" id="modalLabelAgregarrazonSocial">Agregar razonSocial</h4>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="{{ route('razones.store') }}" method="POST" class="row g-3 align-items-center" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                        <button type="submit" class="btn btn-primary">Guardar razonSocial</button>
                    </div>
                </form>
            </div>
        </div>
