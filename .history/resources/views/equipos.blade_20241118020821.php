                ...
                <table id="data-table-buttons" width="100%" class="table table-striped table-bordered align-middle text-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td nowrap>
                                    <button class=" btn btn-sm btn-primary w-60px me-1" data-bs-toggle="modal" data-bs-target="#modal-editar-equi-{{ $equi->id }}">Edit</button>
                                    <!-- Modal para eliminar equi -->
                                    <button class="btn btn-sm btn-white w-60px" data-bs-toggle="modal" data-bs-target="#modal-eliminar-equi-{{ $equi->id }}">Delete</button>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
