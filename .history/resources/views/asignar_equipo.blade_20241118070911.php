            ...
            <div class="panel-heading bg-cyan-700 text-white">
                ...
                <div class="panel-heading-btn">
                    <div class="btn-group my-n1">
                        <button type="button" class="btn btn-indigo  me-1" data-bs-toggle="modal" data-bs-target="#addAsignacionModal">Asignar Equipo</button>
                        <button href="#addAsignacionModal" type="button" data-bs-toggle="modal"class="btn btn-purple btn-l">Agregar Empleado</button>
