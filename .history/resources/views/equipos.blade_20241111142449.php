            ...
            <div class="panel">
                ...
                <table id="data-table-buttons" width="100%" class="table table-striped table-bordered align-middle text-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="align-items: center; text-align:center;">{{ $equipo->nombre }}</td>
                                <td style="align-items: center; text-align:center;">{{ $equipo->tipo }}</td>
                                <td style="align-items: center; text-align:center;">{{ $equipo->cantidad_total }}</td>
                                <td style="align-items: center; text-align:center;">{{ $equipo->cantidad_disponible }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
