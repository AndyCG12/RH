                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('empleados.update', $empleado->id) }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control uppercase" id="rfc" name="rfc" value="{{ $empleado->rfc }}" required maxlength="13">
                                                </div>
                                                <div class="mb-3">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('empleados.store') }}" method="POST" class="row g-3 align-items-center" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="rfc" class="form-label">RFC</label>
                            <input type="text" class="form-control uppercase" id="rfc" name="rfc" required maxlength="13">
                        </div>
                        <div class="mb-3">
                            <label for="fecha_nacimiento" class="form-label">Fecha de Nacimiento</label>
