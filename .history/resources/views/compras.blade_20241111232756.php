            ...
            <form action="{{ route('compra.store') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" id="descripcion" name="descripcion" class="form-control"  required>
                    </div>
                    <div class="mb-3">
                        <label for="cantidad" class="form-label">antidad</label>
                        <input type="number" id="cantidad" name="cantidad" class="form-control" rows="3" required>
                    </div>
                    <div class="mb-3">
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('compra.update', $compra->id) }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="descripcion" class="form-label">descripcion</label>
                        <input type="number" class="form-control" id="descripcion" name="descripcion" rows="3" required value="{{ $compra->descripcion }}"</input>
                    </div>
                    <div class="mb-3">
                        <label for="empleado_id" class="form-label">Empleado</label>
                        <select class="form-select" id="empleado_id" name="empleado_id" required>
                    ...
                    <div class="mb-3">
                        <label for="estado" class="form-label">estado</label>
                        <input type="date" class="form-control" id="estado" name="estado" required value="{{$compra->estado}}" >
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
