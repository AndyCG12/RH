                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('empleado.update', $empleado->id) }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control uppercase-input" id="nombre" name="nombre" value="{{ $empleado->nombre }}" required>
                                                </div>
                                                <div class="col-5">
                                                    <label for="apellidoP" class="form-label">Apellido Paterno</label>
                                                    <input type="text" class="form-control uppercase-input" id="apellidoP" name="apellidoP" value="{{ $empleado->apellidoP }}" required>
                                                </div>
                                                <div class="col-5">
                                                    <label for="apellidoM" class="form-label">Apellido Materno</label>
                                                    <input type="text" class="form-control uppercase-input" id="apellidoM" name="apellidoM" value="{{ $empleado->apellidoM }}" required>
                                                </div>
                                                <div class="mb-3">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <form action="{{ route('em.destroy', $empleado->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
    ...
    <div class="modal fade" id="modal-agregar-empleado" tabindex="-1" aria-labelledby="modalLabelAgregarEmpleado" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('em.store') }}" method="POST" class="row g-3 align-items-center" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                            <label for="nombre" class="form-label">Nombre(s)</label>
                            <input type="text" class="form-control uppercase-input" id="nombre" name="nombre" required>
                        </div>
                        <div class="col-6">
                            <label for="apellidoP" class="form-label">Apellido Paterno</label>
                            <input type="text" class="form-control uppercase-input" id="apellidoP" name="apellidoP" required>
                        </div>
                        <div class="col-6">
                            <label for="apellidoM" class="form-label">Apellido Materno</label>
                            <input type="text" class="form-control uppercase-input" id="apellidoM" name="apellidoM" required>
                        </div>
