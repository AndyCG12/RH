                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('emplea.update', $empleado->id) }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                @method('PUT')
                                                <div class="mb-3">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <form action="{{ route('emplea.destroy', $empleado->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
    ...
    <div class="modal fade" id="modal-agregar-empleado" tabindex="-1" aria-labelledby="modalLabelAgregarEmpleado" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('emplea.store') }}" method="POST" class="row g-3 align-items-center" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                            <label for="nombre" class="form-label">Nombre</label>
