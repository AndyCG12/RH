    ...
    <div class="col-14">
        <div class="panel" data-sortable-id="table-basic-7">
            ...
            <div class="table-responsive table-striped">
                <table id="data-table-buttons" class="table table-striped table-bordered align-middle text-nowrap">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Empleado</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="align-items: center; text-align:center;">{{ $nomina->empleado->nombre }}</td>
                            <td style="align-items: center; text-align:center;">{{ $nomina->puesto->nombre }}</td>
                            <td style="align-items: center; text-align:center;">{{ $nomina->salario }}</td>
                            <td nowrap>
