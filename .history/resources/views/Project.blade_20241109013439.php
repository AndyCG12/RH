        ...
        <div class="panel " data-sortable-id="table-basic-7">
            ...
            <div class="panel-heading bg-cyan-700 text-white">
                ...
                <div class="panel-heading-btn">
                    ...
                    <button data-bs-target="#addProjectModal" class="btn btn-sm btn-indigo flex me-1" data-bs-toggle="modal">Nuevo proyecto</button>
                        <button type="button" class="btn btn-purple btn-xs dropdown-toggle" data-bs-toggle="dropdown"><b class="caret"></b></button>
                        <div class="dropdown-menu dropdown-menu-end">
                            <a href="{{ route('grupo') }}" class="dropdown-item">Departamentos</a>
                    ...
                    <a href="{{ route('grupo') }}" class="btn btn-sm btn-indigo flex me-1">Grupos</a>
                </div>
            </div>
            <!-- END panel-heading -->
            <!-- BEGIN panel-body -->
                    ...
                    <table id="data-table-buttons" width="100%" class="table table-striped table-bordered align-middle text-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td nowrap>
                                    <!-- Botón para Editar -->
                                    <button class="btn btn-sm btn-primary w-60px me-1"
                                    ...
                                    <!-- Botón para Eliminar -->
                                    <button class="btn btn-sm btn-white w-60px"
                                        data-bs-toggle="modal"
                        ...
                        <div class="modal-body">
                            <form id="crearProyectoForm" action="{{ route('project.store') }}" method="POST">
                                ...
                                <div class="form-group mt-3 row ">
                                    <label for="empleados" class="form-label col-form-label col-lg-4">Asignar Empleados</label>
                                    <div class="col-lg-8">
                                        <select name="empleados[]" id="empleados" class=" multi-select2 form-control" multiple required>
...
<div class="modal fade" id="editProjectModal" tabindex="-1" aria-labelledby="editProjectModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="edit-project-form" method="POST" action="{{ route('project.update', $project->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class=" mt-3 row">
                        ...
                        <div class="col-lg-8">
                        <select class=" multi-select2 form-control" id="project-employees" name="empleados[]" multiple required>
                            <optgroup label="Empleados Activos">
                                @foreach($empleados as $empleado)
                                <option value="{{ $empleado->id }}">{{ $empleado->nombre }}</option>
                                @endforeach
