                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="estado" name="estado" required>
                            ...
                            <option value="pendiente" {{ $compra->estado == 'pendiente' ? 'selected' : '' }}>Inactivo</option>
                            <option value="cancelado" {{ $compra->estado == 'cancelado' ? 'selected' : '' }}>Inactivo</option>
                            <option value="comprado" {{ $compra->estado == 'inactivo' ? 'selected' : '' }}>Inactivo</option>
                        </select>
                    </div>
                </div>
                <div class="modal-footer">
