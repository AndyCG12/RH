                ...
                <div class="panel-heading bg-cyan-700 text-white">
                    ...
                    <div class="panel-heading-btn">
                        <div class="btn-group my-n1">
                            <button href="#modal-agregar-razonSocial" type="button" data-bs-toggle="modal"
                                class="btn btn-indigo btn-l">Nueva razon social</button>
                            <button type="button" class="btn btn-indigo btn-xs dropdown-toggle"
                                ...
                                <tr>
                                    ...
                                    <td nowrap>
                                        <button class=" btn btn-sm btn-primary w-60px me-1" data-bs-toggle="modal"
                                            data-bs-target="#modal-editar-razonSocial-{{ $razonSocial->id }}">Edit</button>
                                        <!-- Modal para eliminar razonSocial -->
                                        <button class="btn btn-sm btn-white w-60px" data-bs-toggle="modal"
                                            data-bs-target="#modal-eliminar-razonSocial-{{ $razonSocial->id }}">Delete</button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
    ...
    <div class="modal fade" id="modal-eliminar-razonSocial-{{ $razonSocial->id }}" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>¿Estás seguro de que deseas eliminar al Razón Social <strong>{{ $razonSocial->nombre }}
...
@endforeach
    ...
    <div class="modal fade" id="modal-agregar-razonSocial" tabindex="-1" aria-labelledby="modalLabelAgregarrazonSocial"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('razones.store') }}" method="POST" class="row g-3 align-items-center"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                            <label for="nombre" class="form-label">Nombre</label>
