            ...
            <div class="panel-heading bg-cyan-700 text-white">
                ...
                <div class="panel-heading-btn">
                    <div class="btn-group my-n1">
                        <button type="button" class="btn btn-sm btn-indigo flex me-1" data-bs-toggle="modal" data-bs-target="#addAsignacionModal">Asignar Equipo</button>
                        <button type="button" class="btn btn-indigo  btn-xs -1 dropdown-toggle" data-bs-toggle="dropdown"><b class="caret"></b></button>
