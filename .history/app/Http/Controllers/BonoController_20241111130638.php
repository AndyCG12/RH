...
class BonoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('bonos')->with('success', 'bono agregada con éxito');
    }
    ...
    public function edit(bono $bono)
    {
        ...
        return view('bonos.edit', compact('bono', 'empleados'));
    }
    ...
    public function update(Request $request, bono $bono)
    {
        ...
        return redirect()->route('bonos')->with('success', 'bono actualizada con éxito');
    }
    ...
    public function destroy(bono $bono)
    {
        ...
        return redirect()->route('bonos')->with('success', 'bono eliminada con éxito');
    }
}
