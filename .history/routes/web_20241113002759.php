...
Route::put('/empleados/{incidencia}', [IncidenciaController::class, 'update'])->name('incidencia.update');
Route::delete('/empleados/{incidencia}', [IncidenciaController::class, 'destroy'])->name('incidencia.destroy');
