...
Route::post('/em', [IncidenciaController::class, 'store'])->name('incidencia.store');
Route::put('/em/{incidencia}', [IncidenciaController::class, 'update'])->name('incidencia.update');
Route::delete('/em/{incidencia}', [IncidenciaController::class, 'destroy'])->name('incidencia.destroy');
