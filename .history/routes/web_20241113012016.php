...
Route::post('/empleados', [IncidenciaController::class, 'store'])->name('incidencia.store');
Route::put('/empleados/{empleado}', [IncidenciaController::class, 'update'])->name('empleado.update');
Route::delete('/empleados/{empleado}', [IncidenciaController::class, 'destroy'])->name('empleado.destroy');
Route::resource('empleadoo', EmpleadoController::class);
...
Route::put('/incidencias/{incidencia}', [IncidenciaController::class, 'update'])->name('incidencia.update');
Route::delete('/incidencias/{incidencia}', [IncidenciaController::class, 'destroy'])->name('incidencia.destroy');
