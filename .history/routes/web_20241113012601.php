...
Route::post('/empleados', [IncidenciaController::class, 'store'])->name('incidencias.store');
Route::put('/empleados/{empleados}', [IncidenciaController::class, 'update'])->name('empleados.update');
Route::delete('/empleados/{empleados}', [IncidenciaController::class, 'destroy'])->name('empleados.destroy');
